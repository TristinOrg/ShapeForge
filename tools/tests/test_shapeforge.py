...
class ShapeForgeCliTests(unittest.TestCase):
    def test_parser_exposes_all_commands(self):
        ...
        for command in (
            ...
            "plan", "step", "render", "export-glb", "validate-glb", "export-external", "image-compare", "reference-blueprint", "reference-pipeline", "image-reconstruct", "benchmark-reconstruction", "reconstruct", "discover",
            "repository", "verify"
        ):
