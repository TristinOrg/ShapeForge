...
ShapeForge Schema contains engine-agnostic model, style, semantic-rig, and multi-view reference contracts. It references neither Unity nor any JSON implementation.
